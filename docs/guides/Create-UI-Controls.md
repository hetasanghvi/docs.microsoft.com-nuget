...
- *UIFramework*: The name of the Framework, such as 'WPF', note that UIFramework attribute is required on ToolboxItems nodes on Visual Studio 16.7 Preview 3 or above
